...
internal static class Text {
  ...
  private static class Ja {
    ...
    internal static string BattleDeathPersonText(ERole role,List<PersonId> deathPersons,ECountry? battleCountry) => $"{(role == ERole.attack ? $"{GetCountryText(battleCountry)}領に侵攻" : $"{GetCountryText(battleCountry)}軍の侵攻を守備")}した{string.Join("と",deathPersons.Select(v => v.Value))}が退却できず戦死";
