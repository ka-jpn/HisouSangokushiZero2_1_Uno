...
namespace HisouSangokushiZero2_1_Uno.Code {
	internal static class Turn {
		internal static int GetYear(GameState game) => (game.NowScenario?.MyApplyF(ScenarioData.scenarios.GetValueOrDefault)?.StartYear??0)+(game.PlayTurn??0)/ UIUtil.yearItems.Length;
